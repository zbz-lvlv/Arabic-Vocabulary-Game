...
class Nouns: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //init words
        words.initNounsArabic();
        words.initNounsEnglish();
    ...
    func setWord(){
        ...
        wordIndex = Int(arc4random_uniform(UInt32(Settings.noOfNouns)));
        wordL.text = words.nounsArabic[wordIndex];
    ...
    func setOptions(){
        ...
        for(var c = 0; c < 4; c += 1) {
            ...
            optionBs[c].setTitle(words.nounsEnglish[index], forState: UIControlState.Normal);
        ...
        optionBs[correctOptionIndex].setTitle(words.nounsEnglish[wordIndex], forState: UIControlState.Normal);
