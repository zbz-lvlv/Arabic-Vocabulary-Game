...
class Adverbs: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //init words
        words.initAdvsArabic();
        words.initAdvsEnglish();
    ...
    func setWord(){
        ...
        wordIndex = Int(arc4random_uniform(UInt32(Settings.noOfAdvs)));
        wordL.text = words.advsArabic[wordIndex];
    ...
    func setOptions(){
        ...
        for(var c = 0; c < 4; c += 1) {
            ...
            optionBs[c].setTitle(words.advsEnglish[index], forState: UIControlState.Normal);
        ...
        optionBs[correctOptionIndex].setTitle(words.advsEnglish[wordIndex], forState: UIControlState.Normal);
