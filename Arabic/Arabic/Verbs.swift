...
class Verbs: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //init words
        words.initVerbsArabic();
        words.initVerbsEnglish();
    ...
    func setWord(){
        ...
        wordIndex = Int(arc4random_uniform(UInt32(Settings.noOfVerbs)));
        wordL.text = words.verbsArabic[wordIndex];
    ...
    func setOptions(){
        ...
        for(var c = 0; c < 4; c += 1) {
            ...
            optionBs[c].setTitle(words.verbsEnglish[index], forState: UIControlState.Normal);
        ...
        optionBs[correctOptionIndex].setTitle(words.verbsEnglish[wordIndex], forState: UIControlState.Normal);
